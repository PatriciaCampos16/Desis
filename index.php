...
<body>
    ...
    <div class="form-container">
        <div class="row">
            ...
            <input type="text" id="input_nombreApellido" name="input_nombreApellido" placeholder="Ingrese Nombre y Apellido" onkeypress="return soloLetras(event)">
        </div>

        <div class="row">
            <label for="input_alias">Alias <span id="aliasError"></span></label>
            <input type="text" id="input_alias" name="input_alias" placeholder="Ingrese Alias">
        </div>

        <div class="row">
            <label for="input_rut">RUT <span id="rutError" class="error"></span></label>
            <input type="text" id="input_rut" name="input_rut" placeholder="XX.XXX.XXX-X" oninput="validateRut(this.value)">
        </div>

        <div class="row">
            <label for="input_email">Email <span id="emailOK"></span></label>
            <input type="text" id="input_email" name="input_email" placeholder="Ingrese Email">
        </div>

        <div class="row">
            <label for="select_region">Regi&oacute;n</label>
            <select id="select_region" name="select_region" onchange="obtenerComuna(this.value);">
        ...
        <div class="row">
            ...
            <select id="select_comuna" name="select_comuna">
        ...
        <div class="row">
            ...
            <select id="select_candidato" name="select_candidato">
        ...
        <div class="row">
            ...
            <div class="checkbox-group">
                <input type="checkbox" id="check_web" name="check_web" value="web">
                Web
                <input type="checkbox" id="check_tv" name="check_tv" value="tv">
                TV
                <input type="checkbox" id="check_redesSociales" name="check_redesSociales" value="redes_sociales">
                Redes Sociales
                <input type="checkbox" id="check_amigos" name="check_amigos" value="amigos">
                Amigos
            </div>
        </div>
